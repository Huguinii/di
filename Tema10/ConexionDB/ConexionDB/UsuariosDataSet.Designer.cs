...
namespace ConexionDB {
    ...
    public partial class UsuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class UsuariosDataTable : global::System.Data.TypedTableBase<UsuariosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsuariosRow AddUsuariosRow(string Nombre, string Apellidos) {
...
namespace ConexionDB.UsuariosDataSetTableAdapters {
    ...
    public partial class UsuariosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Usuarios] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Origin" +
                "al_Nombre) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] " +
                "= @Original_Apellidos)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombre], [Apellidos]) VALUES (@Nombre, @Apellidos)" +
                ";\r\nSELECT Id, Nombre, Apellidos FROM Usuarios WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Usuarios] SET [Nombre] = @Nombre, [Apellidos] = @Apellidos WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)));
SELECT Id, Nombre, Apellidos FROM Usuarios WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConexionDB.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Apellidos FROM dbo.Usuarios";
        ...
        public virtual int Update(string Nombre, string Apellidos, int Original_Id, string Original_Nombre, string Original_Apellidos, int Id) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        public virtual int Update(string Nombre, string Apellidos, int Original_Id, string Original_Nombre, string Original_Apellidos) {
            return this.Update(Nombre, Apellidos, Original_Id, Original_Nombre, Original_Apellidos, Original_Id);
        }
    }
